<?php include'header.php';?>
        ...
        <section class="service-section fix mb-5">
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp mt-5" data-wow-delay=".3s">
                        <div class="service-box-items">
                            ...
                            <div class="content"> 
                                <h4 class="blue-back">Detailed Features</h4>
                                <div class="list-items wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <ul>
                                        <li>
                                            ...
                                            AI DSS Insights – KPI planning & Performance 
                                        ...
                                        <li>
                                            ...
                                            Compensation Plan Design: Customizable plans, rules, and policies
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Automation: Automated calculations and reporting
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Analytics and Reporting: Real-time dashboards, predictive analytics
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Integration: Seamless integration with CRM and ERP systems with ready to use API’s 
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Inbuilt workflows to automate approval process
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Mobile Accessibility: Mobile app features and benefits
                                        </li>
        ...
        <!-- Service Section Start -->
        <section class="service-section fix pb-5 section-bg">
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-box-items">
                            ...
                            <div class="content"> 
                                <h4 class="blue-back">Key Benefits</h4>
                                <div class="list-items wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <ul>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            ...
                                            Transform your sales compensation plan designs with our intuitive, easy to use and unique cutting-edge Design Engine.
                                        ...
                                        <li>
                                            ...
                                            Integrate your internal incentives data sources (Financial, HRMS, CRM) with Paragon’s machine-to-machine API technology.
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Efficient management of your sales compensation program with our multi-year, compensation and performance history library.
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Fully automated workflows including plan approvals and participant acceptance, manual adjustments, employee transaction inquiries.
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Robust reporting and dashboard communications centre with “What if” analysis in Real time.
