                ...
                <div class="row g-4 justify-content-between align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content">
                           ...
                           <br>
                                    Our SaaS-based solution stands out from the competition on two aspects one by providing AI enabled insight into KPI’s that drive performance and the other acting as a DSS force for sales team to guide them through the plan achievement journey with Seamlessly integrating with your internal systems—HRIS, CRM, and financial software—via efficient API machine-to-machine transfer protocols which enables plan accurate incentive calculations and robust reporting capabilities.
                            </p>
                            <div class="hero-button">
                                <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                                    <a href="about.php"> <span class="theme-btn">Get started </span></a>
                                </div>
                                <a href="#" class="link-btn wow fadeInUp" data-wow-delay=".5s">Watch a demo</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
        ...
        <section class="team-section-3 fix section-padding">
                ...
                <div class="section-title-area">
                    <div class="section-title text-center">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay=".3s">
                            See how SalesVista can help you!
                        </h2>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="feature-box-items">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">
                                    We built SalesVista to make sales compensation management easy and transparent. Ready to see how we can transform your commission management?
                                </p>
                                 <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                       <img src="assets/img/home2.webp" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="service-section fix section-padding">
            ...
            <div class="container">
                <div class="section-title-area">
                        ...
                        <div class="col-md-8">
                    <img src="assets/img/home3.webp" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/s55.webp" class="img-fluid">
                    </div>
                    
                </div>
                <div class="row mt-5">
                     <div class="col-xl-6 col-lg-6 col-md-6 mt-5 wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/s11.webp" class="img-fluid">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp mt-5" data-wow-delay=".3s">
                        <div class="service-box-items">
                ...
                <div class="row mt-5">
                   ...
                   <div class="col-xl-6 col-lg-6 col-md-6 mt-5 wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/s22.webp" class="img-fluid">
                    </div>
                    
                </div>
                <div class="row mt-5">
                      <div class="col-xl-6 col-lg-6 col-md-6 mt-5 wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/s33.webp" class="img-fluid">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp mt-5" data-wow-delay=".3s">
                        <div class="service-box-items">
                ...
                <div class="row mt-5">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 mt-5 wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/s44.webp" class="img-fluid">
                    </div>
