...
<!--
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="contact-info-items text-center">
                            ...
                            <div class="content">
                                <h3>Hot:<a href="tel:+2086660112">+91 38965 65239</a></h3>
                                <p>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-6">
                            <div class="content card p-3"> 
                                <h4>Get in Touch</h4>
                                <h4 class="mt-3 blue-back">Empower Your Sales Compensation Strategy</h4>
                                <div class="list-items wow fadeInUp mt-4" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <ul>
                                        <li>
                                           ...
                                           AI approach to Incentive Plan Personalisation
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Ensure 100% accuracy in payouts
                                    ...
                                    <ul>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                             ...
                                             Boost team motivation with clear earning visibility
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Achieve predictability outcome of sales compensation programs
                        ...
                        <div class="col-lg-6">
                            <div class="contact-content">
                                <h2>Contact US</h2>
                                <p>
                                   Ready to simplify your sales compensation process and unlock better results? Our experts at Paragon SPM are here to help!
                                </p>
